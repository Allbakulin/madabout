...
var quoteColors = ["239, 72, 54,.95", "102, 51, 153,.95", "65, 131, 215,.95", "38, 166, 91,.95", "247, 202, 24,.95", "248, 148, 6,.95", "108, 122, 137, .95"],
    quotes = ["I happy to see you.", "Have lunch. Or be lunch. It always better have lunch, no?", "Me look for Jane. You help?", 'We go "clubbing"?', "Good, you here. Now we hunt.", "Hello. We relations?", 'Had fight with pet. Now I am dino-"sore".', "You like joke? It pre-hysterical."],
    quotesNew = ["I happy to see you.", "What you do today improve your tomorrows.", "It’s a dinosaur-eat-world! Do awesome stuff before you eaten!", "To succeed, you must believe you can.", "Life is 1 part what happen, and 9 part how you react to what happen.", "It okay to go slow. But you no stop.", "You no catch prey by simply staring at it.", "Fool proof way to succeed is to try just one more time.", "To get ahead. You got to start. Now!", "Begin where you are. Use tools you got. Do what you can.", "If dinosaur come. You no try to pet it. Run!"],
    randomCheck = -1,
    tempNo;
